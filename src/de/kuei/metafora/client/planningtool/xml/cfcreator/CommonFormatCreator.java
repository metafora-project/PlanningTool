package de.kuei.metafora.client.planningtool.xml.cfcreator;
...
public class CommonFormatCreator {
	 ...
	 * CommonFormatCreator(String document) as it doesn't rely on an existing
	...
	public CommonFormatCreator(long time, Classification classification,
			String type, boolean logged, boolean succeed) {
	 ...
	 */
	public CommonFormatCreator(String document) throws DOMParseException {
		doc = XMLParser.parse(document);
